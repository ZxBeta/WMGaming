...
const AboutUs = (props) => {
  return (
    <div className="about-us-container">
      <Helmet>
        <title>About-Us - WEBMOBRIL GAMING STUDIOZ</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="About-Us - WEBMOBRIL GAMING STUDIOZ"
        />
        <meta
        ...
        <div className="about-us-container02">
              ...
              <section className="about-us-container05">
                <div className="about-us-container06">
                  <div className="about-us-container07">
                    <span className="about-us-text colortexter">
                      Transform Your Vision into Stark Reality
                    </span>
                    <span className="about-us-text01">
                      We have a team of experts skilled in crafting and
                      delivering endearing gaming solutions. We offer game
                      development services at their best.
                    </span>
                  </div>
                </div>
          ...
          <section className="about-us-container09">
            <div className="about-us-container10">
              <div className="about-us-container11">
                <div className="about-us-container12">
                  ...
                  <svg viewBox="0 0 1024 1024" className="about-us-icon06">
                    <path d="M768 768v-512h-512v512h512zM768 170q34 0 60 26t26 60v512q0 34-26 60t-60 26h-512q-34 0-60-26t-26-60v-512q0-34 26-60t60-26h512z"></path>
                  </svg>
                </div>
              ...
              <div className="about-us-container14">
                ...
                <span className="about-us-text03">
                  Realizing the enormous potential in the gaming industry, we at
                  WebMobril Gaming Studioz encourage people to come forward with
                  their ideas that we can turn into action. We create the most
                  immersive and awe-inspiring games customized to the specific
                  requirements of our clients across the globe. We strive to
                  provide avant-garde gaming solutions to every client. For
                  this, we have got the best squad of designers, developers and
                  strategists at work, well adapted and trained with evolving
                  technologies.
                </span>
              </div>
            </div>
            <div className="about-us-container15">
              <div className="about-us-container16">
                <span className="about-us-text04 colortexter">Who We Are</span>
            ...
            <div className="about-us-container20">
              <div className="about-us-container21">
                <span className="about-us-text06 colortexter">What We Do</span>
                <span className="about-us-text07">
                  We are one of the fastest growing game development companies
                  supporting multiplatform games across the vast expanse of
                  Mobile, PC, Web and Console gaming. We have pioneered game
          ...
          <section className="about-us-container25">
            <div className="about-us-container26">
              <div className="about-us-container27">
                <span className="about-us-text08 colortexter">Our Vision</span>
            ...
            <div className="about-us-container29">
              <div className="about-us-container30">
                <img
                  alt="image"
                  src="/playground_assets/aboutus_image3-1500w.png"
                  loading="eager"
                  className="about-us-image5"
                />
              </div>
              <div className="about-us-container31">
                <span className="about-us-text13 colortexter">Our Mission</span>
            ...
            <div className="about-us-container32">
              <div className="about-us-container33">
                <span className="about-us-text18 colortexter">Our Mission</span>
          ...
          <section className="about-us-container35">
            <div className="about-us-container36">
              <span className="about-us-text23 colortexter">
                  ...
                  <div className="about-us-container40">
                    <div className="about-us-container41">
                      ...
                      <span className="about-us-text25">
                        IND- Novel MSR Park, 93/9, Marathahalli | Bengaluru,
                        Karnataka | 560037
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="about-us-container44">
                    <div className="about-us-container45">
                      ...
                      <span className="about-us-text27">
                        IND- 08th Floor, World Tech 67 ITC 10, Sector 67| Mohali
                        | Punjab | 160062
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="about-us-container48">
                    <div className="about-us-container49">
                      ...
                      <span className="about-us-text29">
                        IND- # 301, 3rd Floor, Apollo Premier, Vijay Nagar I
                        Indore, MP I 452010
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="about-us-container52">
                    <div className="about-us-container53">
                      ...
                      <span className="about-us-text31">
                        G-18, Sector-63, Noida (Delhi-NCR), PIN: 201301, India
                      </span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="about-us-container56">
                    <div className="about-us-container57">
                      ...
                      <span className="about-us-text33">
                        USA - 8 The Green, Suite A, Dover Delaware 19901
                      </span>
                    </div>
                  </div>
                </div>
