...
const GameArt = (props) => {
  return (
    <div className="game-art-container">
      <Helmet>
        <title>Game-Art - WEBMOBRIL GAMING STUDIOZ</title>
        <meta
          name="description"
        ...
        <meta
          property="og:title"
          content="Game-Art - WEBMOBRIL GAMING STUDIOZ"
        />
        <meta
      ...
      <div className="game-art-container01">
        <div className="game-art-container02">
          <section className="game-art-container03">
            <div className="game-art-container04">
              <div className="game-art-container05">
                <span className="game-art-text outlineColorChanger outliner">
                  <span>AMAZING ARTS</span>
                  <br></br>
                  <span>AT YOUR FINGER TIPS</span>
                </span>
                <span className="game-art-text04">
                  <span>We make games to play beyond reality with</span>
                  <br></br>
                  <span>compelling, </span>
                  <span>creative, </span>
                  <span>and captivating art &amp; animation.</span>
                </span>
              </div>
            </div>
          </section>
          <section className="game-art-container06">
            <div className="game-art-container07">
              <span className="game-art-text10 colortexter">
                <span>Become the game </span>
                <span>changer with best </span>
                <span>game arts &amp; </span>
                <span>animation</span>
                <br></br>
              </span>
              <span className="game-art-text16">
                <span>
                  WebMobril Gaming Studioz understands the significance of
                  delivering creative and trendsetting art solutions that are
                  true to your vision. Our professionals are geared with
                  advanced skills and profound creativity to take care of the
                  entire game production that includes stages from
                  conceptualizing to developing outstanding animated 3D
                  characters, rigging, creating simulated environments, and
                  UI/UX and 2D elements.
                  <span
            ...
            <div className="game-art-container08">
              <div className="game-art-container09">
                <div className="game-art-container10">
                  ...
                  <svg viewBox="0 0 1024 1024" className="game-art-icon02">
                    <path d="M640 470v-86q0-36-25-61t-61-25h-170v86h170v86h-84q-36 0-61 24t-25 60v172h256v-86h-170v-86h84q36 0 61-24t25-60zM810 128q34 0 60 26t26 60v596q0 34-26 60t-60 26h-596q-34 0-60-26t-26-60v-596q0-34 26-60t60-26h596z"></path>
                  </svg>
                  <svg viewBox="0 0 1024 1024" className="game-art-icon04">
                    <path d="M640 448v-64q0-36-24-61t-60-25h-172v86h172v86h-86v84h86v86h-172v86h172q36 0 60-25t24-61v-64q0-28-18-46t-46-18q28 0 46-18t18-46zM812 128q34 0 59 26t25 60v596q0 34-25 60t-59 26h-598q-34 0-60-26t-26-60v-596q0-34 26-60t60-26h598z"></path>
                  </svg>
          ...
          <section className="game-art-container12">
            <div className="game-art-container13">
              <span className="game-art-text19">
                <span>2D &amp; 3D Game</span>
                <br></br>
                <span>Art</span>
              </span>
              <span className="game-art-text23">
                Whether from scratch or to shove your existing production
                pipeline, we can serve you with 2D/ 3D models for video games,
                non-gaming renders or other assets.
              </span>
            </div>
            <div className="game-art-container14">
              <span className="game-art-text24">
                <span>AAA Game</span>
                <br></br>
                <span>Art</span>
              </span>
              <span className="game-art-text28">
                When it comes to AAA-quality art production, we stand out as the
                dynamic player having artistic distinction and acquaintance in
                creating unmatched arts for iOS and Android games, PC and
                console games.
              </span>
            </div>
            <div className="game-art-container15">
              <span className="game-art-text29">
                <span>2D &amp; 3D Game</span>
                <br></br>
                <span>Animation</span>
              </span>
              <span className="game-art-text33">
                We can make your 2D &amp; 3D gaming characters come vividly to
                life depending on the genre you choose. We can model, create a
                layout, animate the characters and render them with our acumen.
                <span
                  dangerouslySetInnerHTML={{
                    __html: ' ',
                  }}
          ...
          <section className="game-art-container16">
            <div className="game-art-container17">
              <div className="game-art-container18">
                ...
                <div className="game-art-container20">
                  <img
                    alt="image"
                    src="https://media2.giphy.com/media/6Nh0MSV3umQOBYHuvT/giphy.gif?cid=ecf05e47by97gy7305jbdsbmfyxxgkj278b4rygrqg86v6db&amp;rid=giphy.gif&amp;ct=g"
                    loading="eager"
                    className="game-art-image1"
                  />
                </div>
              </div>
            </div>
            <div className="game-art-container21">
              <span className="game-art-text34 colortexter">
                <span>Why WebMobril</span>
                <br></br>
                <span>Gaming Studioz</span>
              </span>
              <span className="game-art-text38">
                <span>
                  We boast a team of seasoned designers and artists that provide
                  extraordinary services for multiple game art solutions while
                  supporting game development on all production stages.
                  Contracting with us for the game art solutions will save you
                  from the most taxing and time-consuming tasks so that you can
                  focus on the rest of the things.
                </span>
                <br></br>
                <span>
                  We have an extensive portfolio of game art and animation in
                  wide-ranging genres that reflect our gaming expertise.
                </span>
              </span>
            </div>
          </section>
          <section className="game-art-container22">
            <div className="game-art-container23">
              <span className="game-art-text42">Outstanding Custom Design</span>
              <span className="game-art-text43">
                We help you achieve exceptional and artistic designs for games
                designed as per your specific requirements and vision. Our
                designs depict the exact features you would describe.
              </span>
            </div>
            <div className="game-art-container24">
              <span className="game-art-text44">
                <span>Expert Team of</span>
                <br></br>
                <span>Designers</span>
              </span>
              <span className="game-art-text48">
                We have a team of skilful, certified, and passionate art
                designers who work as your extended team for game development.
                We are the most reliable name for perfect animation and
                character design.
              </span>
            </div>
            <div className="game-art-container25">
              <span className="game-art-text49">
                Latest Technology Equipped Studio
              </span>
              <span className="game-art-text50">
                Our gaming studio is equipped with all kinds of latest tools and
                technologies that allow us to drive the seamless workflow for
                game art solutions.
              </span>
            </div>
          </section>
          <section className="game-art-container26">
            <div className="game-art-container27">
              <div className="game-art-container28">
                <span className="game-art-text51 colortexter">
                  <span>take a look at our gallery.</span>
                  <br></br>
                </span>
              </div>
            </div>
          ...
          <section className="game-art-container41">
            <div className="game-art-container42">
              <span className="game-art-text72 colortexter">
                <span>Art, Design &amp; Animation</span>
                <br></br>
                <span>Services We Offer</span>
              </span>
              <span className="game-art-text76">
            ...
            <div className="game-art-container43">
              <div className="game-art-container44">
                <div className="game-art-container45">
                  <svg
                    viewBox="0 0 865.7188571428571 1024"
                    className="game-art-icon16"
                  >
                ...
                <span className="game-art-text77">Concept Art</span>
              </div>
              <div className="game-art-container46">
                <div className="game-art-container47">
                  <svg
                    viewBox="0 0 1024.5851428571427 1024"
                    className="game-art-icon18"
                  >
                ...
                <span className="game-art-text78">Casual Art</span>
              </div>
              <div className="game-art-container48">
                <div className="game-art-container49">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon20">
                    <path d="M768 768c0-70.699-28.715-134.741-74.965-181.035s-110.336-74.965-181.035-74.965-134.741 28.715-181.035 74.965-74.965 110.336-74.965 181.035c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667c0-47.147 19.072-89.728 50.005-120.661s73.515-50.005 120.661-50.005 89.728 19.072 120.661 50.005 50.005 73.515 50.005 120.661c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667zM149.888 466.219l60.587 60.587c16.683 16.683 43.691 16.683 60.331 0s16.683-43.691 0-60.331l-60.587-60.587c-16.683-16.683-43.691-16.683-60.331 0s-16.683 43.691 0 60.331zM42.667 810.667h85.333c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-85.333c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM896 810.667h85.333c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-85.333c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM813.525 526.805l60.587-60.587c16.683-16.683 16.683-43.691 0-60.331s-43.691-16.683-60.331 0l-60.587 60.587c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0zM981.333 896h-938.667c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667h938.667c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667zM371.499 286.165l97.835-97.835v195.669c0 23.552 19.115 42.667 42.667 42.667s42.667-19.115 42.667-42.667v-195.669l97.835 97.835c16.683 16.683 43.691 16.683 60.331 0s16.683-43.691 0-60.331l-170.667-170.667c-4.096-4.096-8.789-7.168-13.824-9.259s-10.539-3.243-16.341-3.243c-5.547 0-11.136 1.067-16.341 3.243-5.035 2.091-9.728 5.163-13.824 9.259l-170.667 170.667c-16.683 16.683-16.683 43.691 0 60.331s43.691 16.683 60.331 0z"></path>
                  </svg>
                </div>
                <span className="game-art-text79">Environment Design</span>
              </div>
              <div className="game-art-container50">
                <div className="game-art-container51">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon22">
                    <path d="M678 346l190 192-60 60-168-170v510h-86v-256h-84v256h-86v-566q-94-28-154-107t-60-179h86q0 88 62 150t150 62h110q52 0 100 48zM426 170q0-36 25-60t61-24 61 24 25 60-25 61-61 25-61-25-25-61z"></path>
                  </svg>
                </div>
                <span className="game-art-text80">Character Design</span>
              </div>
              <div className="game-art-container52">
                <div className="game-art-container53">
                  <svg
                    viewBox="0 0 1316.5714285714284 1024"
                    className="game-art-icon24"
                  >
                    <path d="M1316.571 438.857h-73.143v365.714h73.143v219.429h-219.429v-73.143h-512v73.143h-219.429v-219.429h73.143v-73.143h-219.429v73.143h-219.429v-219.429h73.143v-365.714h-73.143v-219.429h219.429v73.143h512v-73.143h219.429v219.429h-73.143v73.143h219.429v-73.143h219.429v219.429zM1170.286 292.571v73.143h73.143v-73.143h-73.143zM804.571 73.143v73.143h73.143v-73.143h-73.143zM73.143 73.143v73.143h73.143v-73.143h-73.143zM146.286 731.429v-73.143h-73.143v73.143h73.143zM877.714 658.286h-73.143v73.143h73.143v-73.143zM219.429 658.286h512v-73.143h73.143v-365.714h-73.143v-73.143h-512v73.143h-73.143v365.714h73.143v73.143zM512 950.857v-73.143h-73.143v73.143h73.143zM1243.429 950.857v-73.143h-73.143v73.143h73.143zM1170.286 804.571v-365.714h-73.143v-73.143h-219.429v219.429h73.143v219.429h-219.429v-73.143h-219.429v73.143h73.143v73.143h512v-73.143h73.143z"></path>
                  </svg>
                </div>
                <span className="game-art-text81">Hidden Objects</span>
              </div>
              <div className="game-art-container54">
                <div className="game-art-container55">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon26">
                    <path d="M854 854v-684h-684v684h86v-86h96q-50-64-54-128l-2-12v-18t3-25 7-32 12-36 21-40 33-42 45-45 60-46 77-46q-4 12-6 33t20 74 78 91q80 56 80 144 0 70-44 128h86v86h86zM506 724q40 34 89 15t55-73q4-38-36-78t-48-56q-10 28-4 54 2 8 6 23t5 22-1 23q-4 20-23 41t-43 29zM86 86h852v852h-852v-852z"></path>
                  </svg>
                </div>
                <span className="game-art-text82">Slots Games Art</span>
              </div>
              <div className="game-art-container56">
                <div className="game-art-container57">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon28">
                ...
                <span className="game-art-text83">2D Art</span>
              </div>
              <div className="game-art-container58">
                <div className="game-art-container59">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon32">
              ...
              <div className="game-art-container64">
                ...
                <span className="game-art-text87">3D Characters Design</span>
              </div>
              <div className="game-art-container66">
                <div className="game-art-container67">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon44">
                    ...
                    <path d="M618.667 810.667c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                    <path d="M618.667 512c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                    <path d="M618.667 213.333c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                    <path d="M917.333 810.667c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                    <path d="M917.333 512c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                    <path d="M917.333 213.333c0 58.91-47.756 106.667-106.667 106.667s-106.667-47.756-106.667-106.667c0-58.91 47.756-106.667 106.667-106.667 58.91 0 106.667 47.756 106.667 106.667z"></path>
                  </svg>
                </div>
                <span className="game-art-text88">
              ...
              <div className="game-art-container72">
                ...
                <span className="game-art-text91">UI/UX Design</span>
              </div>
              <div className="game-art-container74">
                <div className="game-art-container75">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon63">
                    <path d="M426 214h470v256h-470v-256zM682 768v-256h214v256h-214zM170 768v-554h214v554h-214zM426 768v-256h214v256h-214z"></path>
                  </svg>
                </div>
                <span className="game-art-text92">Illustration Services</span>
              </div>
              <div className="game-art-container76">
                <div className="game-art-container77">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon65">
                    <path d="M0 1024c128-384 463-1024 1024-1024-263 211-384 704-576 704s-192 0-192 0l-192 320h-64z"></path>
                  </svg>
                </div>
                <span className="game-art-text93">2D Animation</span>
              </div>
              <div className="game-art-container78">
                <div className="game-art-container79">
                  <svg viewBox="0 0 1024 1024" className="game-art-icon67">
                ...
                <span className="game-art-text94">3D Animation</span>
              </div>
              <div className="game-art-container80">
                <div className="game-art-container81">
                  <svg
                    viewBox="0 0 1170.2857142857142 1024"
                    className="game-art-icon69"
                  >
                ...
                <span className="game-art-text95">
